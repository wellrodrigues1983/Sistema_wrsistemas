...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	/**
	 * Realiza consula no banco de dados, iniciando o carregamento a partir do
	 * registro passado no parametro iniciaRegistro obtendo maximo de resultados
	 * passados em maximoResultados
	 */
	@Override
